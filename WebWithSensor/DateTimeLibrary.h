...
#define tz_CEST 0*60*60    ///< Central Europe Summer Time

#define tz_PST 2*60*60    ///< Pacific Standard Time
#define tz_PDT -9*60*60    ///< Pacific Daylight Time

#define tz_CST -8*60*60    ///< Central Standard Time
#define tz_PDT -7*60*60    ///< Central Daylight Time
/// @}
...
///
uint8_t getTimeNTP(time_t &epochNTP, IPAddress serverNTP = IPAddress(24,56,178,140));
